...
'sort data locally and find splitters cycle':0,\
'gather all splitters cycle':0,\
'root splitters sort cycle':0,\
'cast all splitters cycle':0,\
'inner proc dispatch cycle':0,\
'all to all commute cycle':0,\
'inner proc sort cycle':0,\
'gather all proc to root cycle':0,\
'total cycle cost':0}
total_cost_cycle_str = 'total cycle cost'
output_name = 'sort'
calculate_phase_str = 'inner proc sort cycle'
