...
'array bit reverse cycle':0,\
'root node scatter array to leaf cycle':0,\
'leaf node fft first logP cycle':0,\
'parent nodes recv array from children until root cycle':0,\

'total cycle':0}
total_cost_cycle_str = 'total cycle'
output_name = 'fft'
calculate_phase_str = ['parent nodes recv array from children until root cycle','leaf node fft first logP cycle']
